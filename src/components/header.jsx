          ...
          <div className="row">
            <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
              <div className="col-md-8 me-auto">
                <p>Consigue los mejores productos con nosotros</p>
              </div>
              <div className="col-md-2">
                <a href="tel:+254708118414">Contactanos al 987654321</a>
              </div>
            ...
            <div className="d-flex align-items-center  justify-content-between d-md-none">
              <div className="col-md-6 me-auto">
                <p>Ahorra hasta 100%</p>
              </div>
              <div className="col-md-2 m-auto">
                <a href="tel:+254708118414">Llamanos</a>
              </div>
              <div className="col-md-2 m-auto">
                <Link className="links fs-4">
                  <CiMail />
        ...
        <div className="container-xxl">
          <div className="row align-items-center m-0">
            <div className="col-md-2 d-flex justify-content-center">
              ...
              <Link to="/">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvWDVTlS8WUNv-025zmDeWkMd_kVegzJze4Jqn9PAfpGXY24kqRR_zRqaFcggiXsT_xps&usqp=CAU"
                  alt="logo"

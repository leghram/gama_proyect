          ...
          <div className="col-12 col-md-7">
            <div className="p-3">
              ...
              <p className="cart-item-id">
                Marca: <b className="text-center mb-1">{brand}</b>
              </p>
              <p className="cart-item-id">
                Precio: <b className="text-center mb-1">${price}</b>
              </p>
              <p className="cart-item-id">
                Numero Item: <b className="text-center mb-3">{id}</b>
              </p>
              <p className="cart-item-id">
                Items en Stock: <b className="text-danger">{itemsInStock}</b>
              </p>
            </div>
